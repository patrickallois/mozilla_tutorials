...
// try use XHR to retrieve it, and catch any errors that occur in the XHR operation
// once the products have been successfully loaded and formatted as a JSON object
// using request.responseType = 'json', run the send() function
...
function initialize() {
  ...
  function fetchBlob(product) {
    ...
    // Use XHR to retrieve the image, and convert the resulting response to a blob
